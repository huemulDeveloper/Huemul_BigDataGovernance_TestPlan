...
object globalSettings {
   ...
   Global.CONTROL_Setting.append(new HuemulKeyValuePath("production","jdbc:postgresql://35.188.65.185:5432/postgres?user=postgres&password=control-postgres&currentSchema=public"))
   ...
   Global.IMPALA_Setting.append(new HuemulKeyValuePath("production","jdbc:postgresql://35.188.65.185:5432/postgres?user=postgres&password=control-postgres&currentSchema=public"))
   ...
   Global.MDM_Backup_Path.append(new HuemulKeyValuePath("experimental","hdfs://hdfs:///user/data/experimental/backup/"))
