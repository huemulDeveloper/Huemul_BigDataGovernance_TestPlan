  ...
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      case e: Exception => 
        ...
        val IdTestPlan = Control.RegisterTestPlan(TestPlanGroup, "getWhoCanRun_executeOnlyUpdate", "ERROR DE PROGRAMA -  deberia tener errror", "con error 1033", s"con error: ${Control.Control_Error.ControlError_ErrorCode}", Control.Control_Error.ControlError_ErrorCode == 1033)
        Control.RegisterTestPlanFeature("getWhoCanRun_executeOnlyUpdate", IdTestPlan)
