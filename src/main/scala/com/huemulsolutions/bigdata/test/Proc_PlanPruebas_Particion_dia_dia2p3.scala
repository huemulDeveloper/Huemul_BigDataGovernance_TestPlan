...
object Proc_PlanPruebas_Particion_dia_dia2p3 {
  def main(args: Array[String]): Unit = {
    val huemulLib = new HuemulBigDataGovernance("01 - Misma prueba de dia2p1. prueba de reprocesamiento Proc_PlanPruebas_Particion_dia_dia2p1",args,com.yourcompany.settings.globalSettings.global)
    ...
    try {
      ...
      IdTestPlan = Control.RegisterTestPlan(TestPlanGroup, "Resultado Ejecucion dia 02, p1", "Resultado Ejecución 01", "error = false", s"error = ${control_resultado01.controlError.controlErrorIsError}", !control_resultado01.controlError.controlErrorIsError)
