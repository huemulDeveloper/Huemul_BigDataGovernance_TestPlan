...
object Proc_PlanPruebas_fk {
  def main(args: Array[String]): Unit = {
   ...
   //BORRA HDFS ANTIGUO PARA EFECTOS DEL PLAN DE PRUEBAS
      ...
      //Column_DQ_MinLen
      val ErrorReg = TablaMaster.DataFramehuemul.getDQResult.filter { x => x.ColumnName != null && x.ColumnName.toLowerCase() == "TipoValor".toLowerCase() && x.DQ_ErrorCode == 1024 }
      ...
      //Column_DQ_MaxLen
      val numErrores = TablaMaster.DataFramehuemul.getDQResult.count { x => x.DQ_IsError }
