...
object Proc_PlanPruebas_PermisosInsert {
  def main(args: Array[String]): Unit = {
    val huemulLib = new huemul_BigDataGovernance("01 - Proc_PlanPruebas_PermisosInsert",args,com.yourcompany.settings.globalSettings.Global)
    ...
    try {
      ...
      IdTestPlan = Control.RegisterTestPlan(TestPlanGroup, "getWhoCanRun_executeOnlyInsert","Pudo agregar acceso", "no Pudo agregar acceso", s"Pudo agregar acceso", p_testPlan_IsOK = false)
