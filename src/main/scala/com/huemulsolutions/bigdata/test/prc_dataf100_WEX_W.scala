...
object prc_dataf100_WEX_W {
  ...
  def processMaster(huemulBigDataGov: HuemulBigDataGovernance, ControlParent: HuemulControl
    ...
    try {
      ...
      tblDataF100WexW.dfFromRaw(dfRawDataF100,"dataf100_WEX")
      ...
      if (!tblDataF100WexW.executeFull("FinalSaved"))
        Control.raiseError(s"User: error al intentar masterizar los datos (${tblDataF100WexW.errorCode}): ${tblDataF100WexW.errorText}")
