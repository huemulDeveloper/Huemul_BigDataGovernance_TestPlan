...
import com.huemulsolutions.bigdata.common.{huemul_Args, huemul_BigDataGovernance}
...
import com.huemulsolutions.bigdata.tables.master.dataf100_WEX_W

/**
 *
 */
object prc_dataf100_WEX_W {
  ...
  def processMaster(huemulBigDataGov: huemul_BigDataGovernance, ControlParent: huemul_Control
    ...
    try {
      ...
      val tblDataF100WexW = new dataf100_WEX_W(huemulBigDataGov, Control, TipoTabla)
      tblDataF100WexW.DF_from_RAW(dfRawDataF100,"dataf100_WEX")
      tblDataF100WexW.PKCOL1.setMapping("PKCOL1")
      tblDataF100WexW.PKCOL2.setMapping("PKCOL2")
      tblDataF100WexW.UNIQUECOL.setMapping("UNIQUECOL")
      tblDataF100WexW.VACIOCOL.setMapping("NULLCOL")
      tblDataF100WexW.LENGTHCOL.setMapping("LENGTHCOL")
      tblDataF100WexW.DECIMALCOL.setMapping("DECIMALCOL")
      tblDataF100WexW.DATECOL.setMapping("DATECOL")
      tblDataF100WexW.REGEXCOL.setMapping("REGEXCOL")
      tblDataF100WexW.HIERARCHYTEST01_E.setMapping("HIERARCHYTEST01")
      tblDataF100WexW.HIERARCHYTEST01_W.setMapping("HIERARCHYTEST01")
      tblDataF100WexW.HIERARCHYTEST01_WEX.setMapping("HIERARCHYTEST01")
      tblDataF100WexW.HIERARCHYTEST02_E.setMapping("HIERARCHYTEST02")
      tblDataF100WexW.HIERARCHYTEST02_W.setMapping("HIERARCHYTEST02")
      tblDataF100WexW.HIERARCHYTEST02_WEX.setMapping("HIERARCHYTEST02")

      tblDataF100WexW.setApplyDistinct(false) //deshabilitar si DF tiene datos únicos, por default está habilitado

      Control.NewStep("Ejecuta Proceso carga <paises>")
      if (!tblDataF100WexW.executeFull("FinalSaved"))
        Control.RaiseError(s"User: Error al intentar masterizar los datos (${tblDataF100WexW.Error_Code}): ${tblDataF100WexW.Error_Text}")
