...
import com.huemulsolutions.bigdata.tables.master.dataf100_E

/**
 *
 */
object prc_dataf100_E {
  ...
  def main(args : Array[String]) {
    ...
    //val val2:String ="Environment=desa,RegisterInControl=true,TestPlanMode=false,fecha=2020-05-01"
    //val arg2:Array[String] = Array(val2)
  ...
  def processMaster(huemulBigDataGov: HuemulBigDataGovernance, ControlParent: HuemulControl
    ...
    try {
      ...
      tblDataF100E.VACIOCOL.setMapping("NULLCOL")
      tblDataF100E.LENGTHCOL.setMapping("LENGTHCOL")
      tblDataF100E.DECIMALCOL.setMapping("DECIMALCOL")
      tblDataF100E.DATECOL.setMapping("DATECOL")
      tblDataF100E.REGEXCOL.setMapping("REGEXCOL")
      tblDataF100E.HIERARCHYTEST01_E.setMapping("HIERARCHYTEST01")
      tblDataF100E.HIERARCHYTEST01_W.setMapping("HIERARCHYTEST01")
      tblDataF100E.HIERARCHYTEST01_WEX.setMapping("HIERARCHYTEST01")
      tblDataF100E.HIERARCHYTEST02_E.setMapping("HIERARCHYTEST02")
      tblDataF100E.HIERARCHYTEST02_W.setMapping("HIERARCHYTEST02")
      tblDataF100E.HIERARCHYTEST02_WEX.setMapping("HIERARCHYTEST02")
