...
object Proc_PlanPruebas_Particion_dia_dia2p2 {
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      IdTestPlan = Control.RegisterTestPlan(TestPlanGroup, "Resultado Ejecucion dia 02, p2", "Resultado Ejecución 01", "error = false", s"error = ${control_resultado01.controlError.controlErrorIsError}", !control_resultado01.controlError.controlErrorIsError)
