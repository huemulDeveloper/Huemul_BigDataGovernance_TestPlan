...
object Proc_PlanPruebas_Particion_dia_dia3p1 {
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      IdTestPlan = Control.RegisterTestPlan(TestPlanGroup, "Resultado Ejecucion dia 03, p1", "Resultado Ejecución 01", "error = true and code = 1015", s"error = ${control_resultado01.controlError.controlErrorIsError} and code = ${control_resultado01.controlError.controlErrorErrorCode}", control_resultado01.controlError.controlErrorIsError && control_resultado01.controlError.controlErrorErrorCode == 1015 )
