...
import com.huemulsolutions.bigdata.tables.master.tbl_DatosBasicosInsert_exclude
...
object Proc_PlanPruebas_OnlyInsertNew_exclude {
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      val TablaMaster = new tbl_DatosBasicosInsert_exclude(huemulLib, Control,TipoTabla)      
   ...
   //BORRA HDFS ANTIGUO PARA EFECTOS DEL PLAN DE PRUEBAS
      ...
      */
      ...
      Control.RegisterTestPlanFeature("Datos de tipo TimestampType", IdTestPlan)
      var MDM =  Negativo_Maximo.getAs[Boolean]("Cumple_MDM")
