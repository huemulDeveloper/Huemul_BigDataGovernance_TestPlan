...
import com.huemulsolutions.bigdata.tables.master.dataf100_WEX

/**
 *
 */
object prc_dataf100_WEX {
  ...
  def processMaster(huemulBigDataGov: HuemulBigDataGovernance, ControlParent: HuemulControl
    ...
    try {
      ...
      val tblDataF100Wex = new dataf100_WEX(huemulBigDataGov, Control, TipoTabla)
      tblDataF100Wex.dfFromRaw(dfRawDataF100,"dataf100_WEX")
      ...
      if (!tblDataF100Wex.executeFull("FinalSaved"))
        Control.raiseError(s"User: error al intentar masterizar los datos (${tblDataF100Wex.errorCode}): ${tblDataF100Wex.errorText}")
