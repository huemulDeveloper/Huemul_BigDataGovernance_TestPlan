 ...
 */
object Proc_PlanPruebas_Particion_dia_dia2p1 {
  def main(args: Array[String]): Unit = {
    val huemulLib = new HuemulBigDataGovernance("01 - Proc_PlanPruebas_Particion_dia_dia2p1",args,com.yourcompany.settings.globalSettings.global)
