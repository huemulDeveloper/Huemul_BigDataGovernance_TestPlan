  ...
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      if (TipoTabla != HuemulTypeStorageType.HBASE) {
        ...
        Control.NewStep(s"buscando path $path_20170503_super01_internet")
        path_existe = huemulLib.hdfsPath_exists(path_20170503_super01_internet)
        IdTestPlan = Control.RegisterTestPlan(
          TestPlanGroup
          , "dia 01 - existe path path_20170503_super01_internet"
          , s"path buscado = $path_20170503_super01_internet"
          , "path existe = true"
          , s"path existe = $path_existe"
          , path_existe)

        Control.NewStep(s"buscando path $path_20170503_super01_tienda")
        path_existe = huemulLib.hdfsPath_exists(path_20170503_super01_tienda)
        IdTestPlan = Control.RegisterTestPlan(
          TestPlanGroup
          , "dia 01 - existe path path_20170503_super01_tienda"
          , s"path buscado = $path_20170503_super01_tienda"
          , "path existe = true"
          , s"path existe = $path_existe"
          , path_existe)

        Control.NewStep(s"buscando path $path_20170504_super02_tienda")
        path_existe = huemulLib.hdfsPath_exists(path_20170504_super02_tienda)
        IdTestPlan = Control.RegisterTestPlan(
          TestPlanGroup
          , "dia 01 - existe path path_20170504_super02_tienda"
          , s"path buscado = $path_20170504_super02_tienda"
          , "path existe = true"
          , s"path existe = $path_existe"
          , path_existe)

        Control.NewStep(s"buscando path $path_20170504_super02_telefono")
        path_existe = huemulLib.hdfsPath_exists(path_20170504_super02_telefono)
        IdTestPlan = Control.RegisterTestPlan(
          TestPlanGroup
          , "dia 01 - existe path path_20170504_super02_telefono"
          , s"path buscado = $path_20170504_super02_telefono"
          , "path existe = true"
          , s"path existe = $path_existe"
          , path_existe)
      }

      val dfTotal = huemulLib.spark.sql("select * from production_master.tbl_datosparticionMaster")
      ...
      val sql_01 = s"""
           ...
           FROM production_master.tbl_datosparticionMaster
      ...
      val registro01_04 = DF_valida01.where("periodo = '2017-05-03' and empresa = 'super-01' and app = 'tienda'").select("cantidad").first()
      if (registro01_04 == null) {
        IdTestPlan = Control.RegisterTestPlan(
          TestPlanGroup
          , "dia 01 - existe registro 2017-05-03 | super-01 | tienda"
          , s"debe arrojar 2 registros"
          , "registros = 2"
          , s"registros no encontrados"
          , p_testPlan_IsOK = false)
      ...
      val registro01_05 = DF_valida01.where("periodo = '2017-05-03' and empresa = 'super-01' and app = 'internet'").select("cantidad").first()
      if (registro01_05 == null) {
        IdTestPlan = Control.RegisterTestPlan(
          TestPlanGroup
          , "dia 01 - existe registro 2017-05-03 | super-01 | internet"
        ...
        IdTestPlan = Control.RegisterTestPlan(
          ...
          , s"debe arrojar 1 registros"
          , "registros = 1"
          , s"registros = ${registro01_05.getAs[Integer]("cantidad")}"
          , registro01_05.getAs[Integer]("cantidad") == 1)
      }

      val registro01_06 = DF_valida01.where("periodo = '2017-05-04' and empresa = 'super-02' and app = 'internet'").select("cantidad").first()
      if (registro01_06 == null) {
        IdTestPlan = Control.RegisterTestPlan(
          TestPlanGroup
          , "dia 01 - existe registro 2017-05-04 | super-02 | internet"
          , s"debe arrojar 2 registros"
          , "registros = 2"
          , s"registros no encontrados"
          , p_testPlan_IsOK = false)
      ...
      val registro01_07 = DF_valida01.where("periodo = '2017-05-04' and empresa = 'super-02' and app = 'telefono'").select("cantidad").first()
      if (registro01_07 == null) {
        IdTestPlan = Control.RegisterTestPlan(
          TestPlanGroup
          , "dia 01 - existe registro 2017-05-04 | super-02 | telefono"
          , s"debe arrojar 2 registros"
          , "registros = 2"
          , s"registros no encontrados"
          , p_testPlan_IsOK = false)
        ...
        IdTestPlan = Control.RegisterTestPlan(
          ...
          , s"debe arrojar 2 registros"
          , "registros = 2"
          , s"registros = ${registro01_07.getAs[Integer]("cantidad")}"
          , registro01_07.getAs[Integer]("cantidad") == 2)
      }



      val registro01_03 = dfTotal.where("periodo = '2017-05-01' and empresa = 'super-01' and app = 'internet' and idTx = 1 ").select("cantidad").first()
      if (registro01_03 == null) {
        IdTestPlan = Control.RegisterTestPlan(
          TestPlanGroup
          , "dia 01 - existe registro 2017-05-01 | super-01 | internet | tx1"
        ...
        IdTestPlan = Control.RegisterTestPlan(
          TestPlanGroup
          , "dia 01 - existe registro 2017-05-01 | super-01 | tieda | tx1"
          , s"valor atributo cantidad = 100"
          , "cantidad = 100"
          , s"registros = ${registro01_03.getAs[Integer]("cantidad")}"
          , registro01_03.getAs[Integer]("cantidad") == 100)
      }
