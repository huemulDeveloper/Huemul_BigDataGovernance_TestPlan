...
class dataf100_E(huemulBigDataGov: HuemulBigDataGovernance, Control: HuemulControl, TipoTabla: HuemulTypeStorageType)
  extends HuemulTable(huemulBigDataGov, Control) with Serializable {

  val notifLevel: HuemulTypeDqNotification.Value = HuemulTypeDqNotification.ERROR
